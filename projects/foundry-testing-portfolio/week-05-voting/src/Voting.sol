...
contract Voting {
    ...
    function registerVotersBatch(address[] calldata _voters, uint256[] calldata _weights)
        external
        onlyAdmin
    {
        ...
        returns (uint256)
    {
        ...
        emit ProposalCreated(
            proposalId, msg.sender, _description, block.timestamp, block.timestamp + votingPeriod
        );
